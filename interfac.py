...
     CFD ANSYS CFX SST k-ω | Warman 10/8 M D₂=549mm | PFE 2025–2026 EMI
""", unsafe_allow_html=True)
# ══════════════════════════════════════════════════════════════════════════════
# SIDEBAR
# ══════════════════════════════════════════════════════════════════════════════
...
    st.markdown(f'⚠️ H unitaire ({H_unit:.1f}m) > H utile ({H_utile:.1f}m) — '
                f'Augmenter le nombre de PATs ou réduire S.',unsafe_allow_html=True)
else:
    st.markdown(f'✅ Architecture validée — {N_pat} PAT(s) × {H_par_pat:.1f}m = '
                f'{H_utile:.1f}m utile | ΔP disque = {dP_disque:.1f}bar',
                unsafe_allow_html=True)
# ══════════════════════════════════════════════════════════════════════════════
# ONGLETS
# ══════════════════════════════════════════════════════════════════════════════
...
with T1:
    st.markdown('Dimensionnement par Loi de Similitude',
                unsafe_allow_html=True)
...
with T2:
    st.markdown('Architecture Multi-PAT — Bilan de Pression',
                unsafe_allow_html=True)
    # Bilan de pression
...
        if ni<n_show-1: &#x26;nbsp;&#x26;nbsp;&#x26;nbsp;&#x26;nbsp;&#x26;nbsp;&#x26;nbsp;&#x26;nbsp;&#x26;nbsp;&#x26;nbsp;&#x26;nbsp;&#x26;nbsp;&#x26;nbsp;arr(xp+0.34,yp,xp+spacing-0.34,yp,&#x27;#4fc3f7&#x27;,1.8)="" &#x26;nbsp;&#x26;nbsp;&#x26;nbsp;&#x26;nbsp;if="" n_pat=""> 5:
...
            "Conseil":"✅ Optimal" if 0.7<sr<1 3="" class="6 sh" else(&#x22;⚠️="" Érosion&#x22;="" if="" sr&#x3C;2.2="" else&#x22;❌="" Éviter&#x22;)="" &#x26;nbsp;&#x26;nbsp;&#x26;nbsp;&#x26;nbsp;&#x26;nbsp;&#x26;nbsp;&#x26;nbsp;&#x26;nbsp;})="" &#x26;nbsp;&#x26;nbsp;&#x26;nbsp;&#x26;nbsp;df_conf="pd.DataFrame(configs)" &#x26;nbsp;&#x26;nbsp;&#x26;nbsp;&#x26;nbsp;def="" hi(row):="" &#x26;nbsp;&#x26;nbsp;&#x26;nbsp;&#x26;nbsp;&#x26;nbsp;&#x26;nbsp;&#x26;nbsp;&#x26;nbsp;return="" [&#x27;background-color:#e8f5e9&#x27;]*len(row)="" int(row[&#x22;n="" pats&#x22;])="=N_pat" else="" [&#x27;&#x27;]*len(row)="" &#x26;nbsp;&#x26;nbsp;&#x26;nbsp;&#x26;nbsp;st.dataframe(df_conf.style.apply(hi,axis="1),use_container_width=True,hide_index=True)" #="" ───="" tab="" —="" maintenance="" &#x26;="" usure="" ─────────────────────────────────────────────="" with="" t3:="" &#x26;nbsp;&#x26;nbsp;&#x26;nbsp;&#x26;nbsp;st.markdown(&#x27;&#x3C;div="">Maintenance &#x26; Durée de Vie — Validation Weir 1800h',
                unsafe_allow_html=True)
    # Alertes
    if not weir_ok:
...
 corriger le code</sr<1></n_show-1:>
